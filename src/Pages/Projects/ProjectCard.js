...
function ProjectCard({project, selectedProjectId, updateSelectedProjectId}) {
    ...
    return ( 
        ...
        >
            ...
            <div onClick={select} className={`relative hover:cursor-pointer border-black border-2 max-w-[670px] m-auto h-[25vh] sm:h-[33vh] ${selectedProjectId === project.id && 'h-[65vh] sm:h-[75vh]'} transition-height duration-1000`}>
