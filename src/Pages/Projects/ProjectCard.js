...
function ProjectCard({project, selectedProjectId, updateSelectedProjectId}){
    ...
    return ( 
        ...
        <div
            className={`relative drop-shadow-xl m-auto border-b-2 border-x-2 bg-black text-white overflow-hidden grid place-content-start h-[30vh] sm:h-[40vh] max-w-[546px] ${cardSelected && 'h-[80vh] sm:h-[75vh] '} transform-all duration-500`}
        >
