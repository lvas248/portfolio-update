    ...
    return ( 
        ...
        >
            ...
            <div className='h-[67vh] grid px-5'>
                ...
                <button onClick={()=>scrollToSection('contact')} className='border-2 border-black max-h-[150px] w-[67vw] max-w-[750px] bg-white mx-auto font-bold text-md drop-shadow-xl hover:animate-scale-up rounded-xl'>GET IN TOUCH</button>
